...
<head>
    ...
    <title>MartX - Admin(View Furnitures)</title>
</head>
<body>
    <div class="top">
    ...
    <ul class="nav nav-underline">
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsHomeAppliances.php">Home Appliances</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="#">Furnitures</a>
        </li>
        <li class="nav-item">
    ...
    $query = "select * from $tabledb where itemCategory = 'Furnitures' and itemQuantity > 0";
