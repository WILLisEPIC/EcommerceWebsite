...
<head>
    ...
    <title>MartX - Admin(View Cosmetics)</title>
</head>
<body>
    <div class="top">
    ...
    <ul class="nav nav-underline">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="#">Cosmetics</a>
        </li>
        <li class="nav-item">
    ...
    $query = "select * from $tabledb where itemCategory = 'Cosmetics' and itemQuantity > 0";
