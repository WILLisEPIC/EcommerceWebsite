...
<head>
    ...
    <title>MartX - Admin(View Home Appliances)</title>
</head>
<body>
    <div class="top">
    ...
    <ul class="nav nav-underline">
        <li class="nav-item">
            <a class="nav-link active" href="#">Available Items</a>
        </li>
        <li class="nav-item">
    ...
    <ul class="nav nav-underline">
        <li class="nav-item">
            <a class="nav-link active" href="#">Home Appliances</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsClothing.php">Clothing</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsElectronics.php">Electronics</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsFurnitures.php">Furnitures</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsAccessories.php">Accessories</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsSports.php">Sports</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsKitchen.php">Kitchen</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsCosmetics.php">Cosmetics</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ViewItemsFootwear.php">Footwear</a>
        </li>
    </ul>
    <hr>
    ...
    $query = "select * from $tabledb where itemCategory = 'HomeAppliances' and itemQuantity > 0";
