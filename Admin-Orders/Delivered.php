...
<head>
    ...
    <title>MartX - Admin(Delivered Orders)</title>
</head>
<body>
    <div class="top">
    ...
    <ul class="nav nav-underline">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="#">Delivered Orders</a>
        </li>
    </ul>
    <hr>
    ...
    $orderQUERY = "select * from $orderdb where orderStatus = 'delivered' ORDER BY orderID DESC";
