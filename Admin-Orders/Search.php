...
<head>
    ...
    <title>MartX - Admin Order Search(<?php echo $_GET['search'];?>)</title>
</head>
<body>
    <div class="top">
    ...
    <ul class="nav nav-underline">
        ...
        <li class="nav-item">
            <a class="nav-link" href="Processing.php">Orders</a>
        </li>
    </ul>
    <hr>
    <ul class="nav nav-underline">
        ...
        <li class="nav-item">
            <a class="nav-link" href="Delivering.php">Delivering Orders</a>
        </li>
        <li class="nav-item">
    ...
    <h3>Orders related with - <?php echo $_GET['search']; ?></h3>
    <?php
    $host = "localhost";
    $user = "root";
    $passwd = "";
    ...
    $orderQUERY = "select * from $orderdb where orderID LIKE '%$key%' OR UserID LIKE '%$key%'";
