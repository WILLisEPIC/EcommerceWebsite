...
<head>
    ...
    <title>MartX - Admin(Processing Orders)</title>
</head>
<body>
    <div class="top">
    ...
    <ul class="nav nav-underline">
        <li class="nav-item">
            <a class="nav-link active" href="#">Processing Orders</a>
        </li>
        <li class="nav-item">
    ...
    $orderQUERY = "select * from $orderdb where orderStatus = 'processing' ORDER BY orderID DESC";
